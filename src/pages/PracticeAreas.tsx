...
const PracticeAreas = () => (
  <div className="bg-ivory-100 min-h-screen">
    <section className="bg-navy-900 text-ivory-100 py-20"><div className="container mx-auto px-6 max-w-4xl text-center"><h1 className="text-4xl md:text-6xl font-serif mb-4 text-gold-500">Practice Areas</h1><div className="w-24 h-1 bg-gold-500 mx-auto mb-6"></div><p className="text-xl text-gray-300">Comprehensive legal services backed by over 31 years of experience.</p></div></section>
