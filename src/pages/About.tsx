        ...
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="flex flex-col md:flex-row gap-16 items-start">
            <div className="flex-1">
              ...
              <p className="text-gray-700 text-lg leading-relaxed mb-6">Established in legal practice in 1996, Advocate Vineet Kumar Misra brings approximately 30+ years of steadfast legal experience to his clients in Lucknow. With a foundation built on trust, clear communication, and an unwavering commitment to the law, his chambers handle a diverse range of complex legal matters.</p>
