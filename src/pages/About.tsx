        ...
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="flex flex-col md:flex-row gap-16 items-start">
            <div className="flex-1">
              ...
              <p className="text-gray-700 text-lg leading-relaxed mb-6">Established in legal practice in 1995, Advocate Vineet Kumar Misra brings approximately 31 years of steadfast legal experience to his clients in Lucknow. With a foundation built on trust, clear communication, and an unwavering commitment to the law, his chambers handle a diverse range of complex legal matters.</p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-10">
                <div className="flex items-center gap-4 bg-white p-4 rounded shadow-sm border border-gold-500/20"><Calendar className="text-gold-500" size={32} /><div><h4 className="font-serif text-navy-900 font-bold">Established</h4><p className="text-gray-600">1995 (31 Years)</p></div></div>
