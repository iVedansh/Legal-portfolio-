...
const Home = () => {
  ...
  return (
    <div>
      ...
      <section className="py-24 bg-navy-900 text-ivory-100"><div className="container mx-auto px-6 max-w-4xl text-center"><h2 className="text-4xl font-serif text-gold-500 mb-8">About Vineet Kumar Misra</h2><p className="text-lg text-gray-300 leading-relaxed mb-10">Established in legal practice in 1995, Advocate Vineet Kumar Misra brings over three decades of steadfast legal experience to his clients in Lucknow. With a foundation built on trust, clear communication, and an unwavering commitment to the law, his chambers handle a diverse range of complex legal matters across the High Court, Civil Court, Criminal Court, and District & Sessions Courts.</p><Link to="/about" className="inline-block border-2 border-gold-500 text-gold-500 hover:bg-gold-500 hover:text-navy-900 px-8 py-3 rounded font-semibold transition-all">Read Full Profile</Link></div></section>
